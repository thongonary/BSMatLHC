...
private:
  ...
  /*
    begin customer variables
  */

  //custom variables
  bool doHVRun;

  //confinement scale for the hidden sector
  double HiddenLambda;
  
  //number of bosonic flavor for the hidden sector
  //(used for running);
  int nBFlavRun;

  //number of fermionic flavor for the hidden sector
  //(used for running);
  int nFFlavRun;
