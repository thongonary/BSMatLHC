...
GC_43 = Coupling(name = 'GC_43',
                 value = '-(cw*complex(0,1)*yx)/2.',
                 order = {'HIG':1,'QED':1})

GC_44 = Coupling(name = 'GC_44',
                 value = '(complex(0,1)*sw*yx)/2.',
                 order = {'HIG':1,'QED':1})

GC_45 = Coupling(name = 'GC_45',
                 value = '-(cw*complex(0,1)*vev*yx)/2.',
                 order = {'HIG':1})

GC_46 = Coupling(name = 'GC_46',
                 value = '(complex(0,1)*sw*vev*yx)/2.',
                 order = {'HIG':1})

GC_47 = Coupling(name = 'GC_47',
                 value = '(cw**2*ee*complex(0,1)*yx)/(2.*sw) + (ee*complex(0,1)*sw*yx)/2.',
                 order = {'HIG':1,'QED':2})

GC_48 = Coupling(name = 'GC_48',
                 value = '-(cw*ee*complex(0,1)*yx)/2. - (ee*complex(0,1)*sw**2*yx)/(2.*cw)',
                 order = {'HIG':1,'QED':2})

GC_49 = Coupling(name = 'GC_49',
                 value = '(cw**2*ee*complex(0,1)*vev*yx)/(2.*sw) + (ee*complex(0,1)*sw*vev*yx)/2.',
                 order = {'HIG':1,'QED':1})

GC_50 = Coupling(name = 'GC_50',
                 value = '-(cw*ee*complex(0,1)*vev*yx)/2. - (ee*complex(0,1)*sw**2*vev*yx)/(2.*cw)',
                 order = {'HIG':1,'QED':1})

GC_51 = Coupling(name = 'GC_51',
                 value = '(cw**2*ee*complex(0,1)*vev**2*yx)/(4.*sw) + (ee*complex(0,1)*sw*vev**2*yx)/4.',
                 order = {'HIG':1})

GC_52 = Coupling(name = 'GC_52',
                 value = '-(cw*ee*complex(0,1)*vev**2*yx)/4. - (ee*complex(0,1)*sw**2*vev**2*yx)/(4.*cw)',
                 order = {'HIG':1})
