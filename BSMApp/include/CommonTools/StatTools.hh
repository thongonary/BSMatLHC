...
#ifndef PoissonLogNormal_h
#define PoissonLogNormal_h

#include "Math/IFunction.h"
#include "Math/IParamFunction.h"
 
class PoissonLogNormal: public ROOT::Math::IParametricFunctionOneDim
{
private:
   const double *pars;
...
public:
   double DoEvalPar(double x,const double* p) const
   {
     ...
     double s = p[2];
     double n = p[3];
     return TMath::Poisson(n, s+b)*TMath::LogNormal(b,TMath::Log(1+SigB/CenB),0,CenB);
   }
