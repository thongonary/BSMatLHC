...
// Mon Feb 27 11:32:23 2017 by ROOT version 6.08/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxParticle = 3427;
   static const Int_t kMaxGenJet = 10;
   static const Int_t kMaxGenMissingET = 1;
   static const Int_t kMaxEFlowTrack = 191;
   static const Int_t kMaxEFlowPhoton = 232;
   static const Int_t kMaxEFlowNeutralHadron = 138;
   static const Int_t kMaxPhoton = 8;
   static const Int_t kMaxElectron = 2;
   static const Int_t kMaxMuonLoose = 2;
   static const Int_t kMaxMuonTight = 2;
   static const Int_t kMaxJet = 9;
   static const Int_t kMaxFatJet = 3;
...
#ifdef DelphesTree_cxx
DelphesTree::DelphesTree(TTree *tree) : fChain(0) 
{
...
Long64_t DelphesTree::LoadTree(Long64_t entry)
{
...
void DelphesTree::Show(Long64_t entry)
{
...
Int_t DelphesTree::Cut(Long64_t entry)
{
